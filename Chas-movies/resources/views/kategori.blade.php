...
<body class="bg-gray-900">
    ...
    <section class="px-6 py-8 flex-col pl-80 pr-100">
        <article class="  bg-gray-700  border-black border-opacity-0 hover:border-opacity-5 rounded-xl  ">
            <div class="py-8 px-5 lg:flex  ">
                <div class="  lg:mr-8 pl-2 flex flex-wrap -mx-1 lg:-mx-4">
                    <img alt="Placeholder" class=" mr-4 rounded-xl block h-40 w-65" src="https://m.media-amazon.com/images/M/MV5BZjdkOTU3MDktN2IxOS00OGEyLWFmMjktY2FiMmZkNWIyODZiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg">
                    <img alt="Placeholder" class=" rounded-xl block h-40 w-65" src="https://m.media-amazon.com/images/M/MV5BZjdkOTU3MDktN2IxOS00OGEyLWFmMjktY2FiMmZkNWIyODZiXkEyXkFqcGdeQXVyMTMxODk2OTU@._V1_.jpg">

                </div>

                <div class="flex-1 flex flex-col justify-between  max-h-22">
                    <header class="mt-8 lg:mt-0">
                        <div class="space-x-2">
                            <a href="#" class="px-3 py-1 border border-grey rounded-full text-blue-300 text-xs uppercase font-semibold" style="font-size: 10px">New Movies</a>

                            <a href="#" class="px-3 py-1 border border-red-300 rounded-full text-red-300 text-xs uppercase font-semibold" style="font-size: 10px">Popular</a>
                        </div>

                        <div class="mt-4  text-gray-300">
                            <h1 class=" text-1xl  max-h-5">
                    ...
                    <footer class="text-gray-300  flex justify-between items-center mt-8">
                        <div class="flex items-center text-sm">

                            <div class="ml-3">
                                <h5 class="font-bold">Adventure Drama Sci-Fi</h5>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <p class="ml-2 text-sm font-medium  ">4.95 out of 5</p>
                                </div>
                            </div>
                        </div>
                        <div class="hidden lg:block">
                            <a href="#" class="transition-colors duration-300 text-xs font-semibold bg-gray-200 text-black hover:bg-gray-300 rounded-full py-2 px-8">Read More</a>
                        </div>
                    </footer>
                </div>
            </div>
        ...
        <!-- Category Start -->
        <header class="  bg-gray-700 text-black hover:bg-gray-700  flex justify-between items-center max-w-x mx-auto mt-10  rounded-xl ">
            <div class="mr-4 relative flex lg:inline-flex  ">
                <select class="flex-1 mr-2 appearance-none bg-transparent text-white py-2 pl-3 pr-9 text-sm font-semibold">
                    <option value="category">Movies </option>
                    <option value="personal">Movies 📽</option>
                    <option value="business">Series 🎞</option>
                </select>
            ...
            <div class="mr-4 relative flex lg:inline-flex">
                <select class="flex-1 mr-2 appearance-none bg-transparent text-white py-2 pl-3 pr-9 text-sm font-semibold">
                    <option value="category" disabled selected>Top
                    </option>
        ...
        <div class=" flex justify-center">
            <nav aria-label="Page navigation example">
                <ul class="inline-flex items-center -space-x-px ">
                    <li><a href="#" class="block px-3 py-2 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                            <span class="sr-only">Previous</span>
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                            </svg>
                        </a></li>
                    <li><a href="#" class="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">1</a>
                    </li>
                    <li><a href="#" class="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">2</a>
                    </li>
                    <li><a href="#" aria-current="page" class="z-10 px-3 py-2 leading-tight text-blue-600 border border-blue-300 bg-blue-50 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
                    </li>
                    <li><a href="#" class="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">4</a>
                    </li>
                    <li><a href="#" class="px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">5</a>
                    </li>
                    <li><a href="#" class="block px-3 py-2 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <footer class=" rounded-xl text-center py-10 px-5 mt-16">
            <h1 class="mb-4 text-xl font-extrabold text-white-900 text-white md:text-2xl lg:text-x"><span class="text-transparent bg-clip-text bg-gradient-to-r to-gray-600 from-sky-400">Chas-movies</span> The best quality </h1>
            <p class="text-lg font-normal text-gray-500 lg:text-x dark:text-gray-400">Here at Chas-movies we focus on good q uality, with different languages and free for the public.</p>
            <div class="mt-10">
                <div class=" relative inline-block mx-auto lg:bg-gray-200 rounded-full">
                    <form method="POST" action="#" class="lg:flex text-sm">
                        ...
                        <button type="submit" class=" transition-colors duration-300 bg-gray-500 hover:bg-blue-600 mt-4 lg:mt-0 lg:ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-8">Subscribe
                        </button>
                    </form>
                </div>
            </div>
