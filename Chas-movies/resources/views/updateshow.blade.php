...
@if (Auth::user()->role == 0)
<h1 class=" ml-3 text-xl dark:text-gray-300 self-center">Update show</h1>
                    <form method="POST" action="/editshow" class="py-8 space-y-2 flex flex-col">
                        @csrf
                        ...
                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="seasons">Seasons</label>
                        <input type="text" name="seasons" value="{{ $data->seasons}}">
                        <label class="block font-medium text-sm text-gray-700 dark:text-gray-300" for="episodes">Episodes</label>
                        <input type="text" name="episodes" value="{{ $data->episodes}}">
