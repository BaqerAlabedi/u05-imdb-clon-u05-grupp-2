    ...
    <div class="w-400 mx-auto bg-gray-500 py-40 px-17 md:px-12 lg:px-14 rounded-lg shadow-lg">
      <div class="flex items-center justify-between">
        <div class="flex-shrink-0">
          <img src="https://via.placeholder.com/150" alt="Admin Profile Image" class="w-32 h-32 rounded-full shadow-lg">
        </div>
        <div class="flex-1 ml-4 text-center md:text-left">
          <h2 class="text-lg font-medium mb-2 text-white">Admin Name</h2>
          <p class="text-gray-300">Admin since January 1, 2021</p>
        </div>
      </div>
      <div class="mt-6 grid gap-6 max-w-lg mx-auto lg:grid-cols-3">
        <div class="bg-gray-800 hover:bg-gray-700 rounded-lg p-6 text-center">
          <p class="text-gray-300">Users Managed</p>
          <p class="text-white font-medium">5,678</p>
        </div>
        <div class="bg-gray-800 hover:bg-gray-700 rounded-lg p-6 text-center">
          <p class="text-gray-300">Reports Processed</p>
          <p class="text-white font-medium">1,234</p>
        </div>
        <div class="bg-gray-800 hover:bg-gray-700 rounded-lg p-6 text-center">
          <p class="text-gray-300">Tasks Completed</p>
